...
class RobotFilter(KalmanFilter):
    ...
    INITIAL_STATE_COVARIANCE = RobotConst.INITIAL_STATE_COVARIANCE

    POSITION_PROCESS_COVARIANCE = RobotConst.POSITION_PROCESS_COVARIANCE
    VELOCITY_PROCESS_COVARIANCE = RobotConst.VELOCITY_PROCESS_COVARIANCE
    ORIENTATION_PROCESS_COVARIANCE = RobotConst.ORIENTATION_PROCESS_COVARIANCE
    ANGULAR_VELOCITY_PROCESS_COVARIANCE = RobotConst.ANGULAR_VELOCITY_PROCESS_COVARIANCE

    POSITION_OBSERVATION_COVARIANCE = RobotConst.POSITION_OBSERVATION_COVARIANCE
